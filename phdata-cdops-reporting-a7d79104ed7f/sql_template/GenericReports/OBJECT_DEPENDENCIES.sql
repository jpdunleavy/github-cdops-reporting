...
DROP TABLE IF EXISTS CDOPS_STATESTORE.REPORTING.CDOPS_OBJECT_DEPENDENCIES;

CREATE TRANSIENT TABLE IF NOT EXISTS CDOPS_STATESTORE.REPORTING.CDOPS_OBJECT_DEPENDENCIES (
